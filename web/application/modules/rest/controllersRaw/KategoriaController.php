...
class Rest_KategoriaController extends Iron_Controller_Rest_BaseController
{
    ...
    /**
     * @ApiDescription(section="Kategoria", description="Create's a new Kategoria")
     * @ApiMethod(type="post")
     * @ApiRoute(name="/rest/kategoria/")
     ...
     * @ApiReturnHeaders(sample="Location: /rest/kategoria/{id}")
     * @ApiReturn(type="object", sample="{}")
     */
    ...
    /**
     * @ApiDescription(section="Kategoria", description="Table Kategoria")
     * @ApiMethod(type="put")
     * @ApiRoute(name="/rest/kategoria/")
