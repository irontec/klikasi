...
class OptionCustomizer implements \KlearMatrix_Model_Interfaces_ParentOptionCustomizer
{
   /**
    ...
    */
    public function customize($parentModel)
    {
        ...
        if ($this->_option->getName() == 'ikastegiaModeration_dialog') {
            if ($parentModel->getAktibatua() == 0) {
                return null;
            }
        }
