...
class Esteka extends TableAbstract
{
    /**
    ...
    protected $_rowClass = 'Klikasi\\Model\\Esteka';
    protected $_rowMapperClass = 'Klikasi\\Mapper\\Sql\\Esteka';
