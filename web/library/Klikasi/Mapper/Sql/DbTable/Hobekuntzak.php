...
/**
 * Table definition for Hobekuntzak
 *
 * @package Klikasi\Mapper\Sql\DbTable
 * @subpackage DbTable
 * @author Irontec
...
class Hobekuntzak extends TableAbstract
{
    /**
    ...
    protected $_rowClass = 'Klikasi\\Model\\Hobekuntzak';
    protected $_rowMapperClass = 'Klikasi\\Mapper\\Sql\\Hobekuntzak';
