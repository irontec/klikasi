...
class Gustokoa extends TableAbstract
{
    /**
    ...
    protected $_rowClass = 'Klikasi\\Model\\Gustokoa';
    protected $_rowMapperClass = 'Klikasi\\Mapper\\Sql\\Gustokoa';
