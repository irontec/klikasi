...
/**
 * Table definition for Aurkezpena
 *
 * @package Klikasi\Mapper\Sql\DbTable
 * @subpackage DbTable
 * @author Irontec
...
class Aurkezpena extends TableAbstract
{
    /**
    ...
    protected $_rowClass = 'Klikasi\\Model\\Aurkezpena';
    protected $_rowMapperClass = 'Klikasi\\Mapper\\Sql\\Aurkezpena';
