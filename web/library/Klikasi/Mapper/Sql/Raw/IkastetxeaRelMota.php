...
class IkastegiaRelMota extends MapperAbstract
{
     ...
     */
    public function save(\Klikasi\Model\Raw\IkastegiaRelMota $model)
    {
     ...
     * @return boolean If the save action was successful
     */
    public function saveRecursive(\Klikasi\Model\Raw\IkastegiaRelMota $model, $useTransaction = true, $transactionTag = null)
    {
