...
class IkastegiMota extends MapperAbstract
{
     ...
     */
    public function save(\Klikasi\Model\Raw\IkastegiMota $model)
    {
     ...
     * @return boolean If the save action was successful
     */
    public function saveRecursive(\Klikasi\Model\Raw\IkastegiMota $model, $useTransaction = true, $transactionTag = null)
    {
