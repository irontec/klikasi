...
class KanpainaRelIkastegiMota extends MapperAbstract
{
    ...
    public function toArray($model)
    {
        ...
        $result = array(
            ...
            'ikastegiMotaId' => $model->getIkastegiMotaId(),
        );
     ...
     */
    public function save(\Klikasi\Model\Raw\KanpainaRelIkastegiMota $model)
    {
     ...
     * @return boolean If the save action was successful
     */
    public function saveRecursive(\Klikasi\Model\Raw\KanpainaRelIkastegiMota $model, $useTransaction = true, $transactionTag = null)
    {
    ...
    public function loadModel($data, $entry = null)
    {
        ...
        if (is_array($data)) {
            $entry->setId($data['id'])
                  ...
                  ->setIkastegiMotaId($data['ikastegiMotaId']);
            ...
            $entry->setId($data->getId())
                  ...
                  ->setIkastegiMotaId($data->getIkastegiMotaId());
