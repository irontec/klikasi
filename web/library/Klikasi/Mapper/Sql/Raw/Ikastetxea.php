...
class Ikastegia extends MapperAbstract
{
     ...
     */
    public function save(\Klikasi\Model\Raw\Ikastegia $model)
    {
     ...
     * @return boolean If the save action was successful
     */
    public function saveRecursive(\Klikasi\Model\Raw\Ikastegia $model, $useTransaction = true, $transactionTag = null)
    {
