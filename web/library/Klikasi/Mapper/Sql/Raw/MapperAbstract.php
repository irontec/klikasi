...
{
    /**
     * $_dbTable - instance of Klikasi\Mapper\DbTable\TableAbstract
     *
     * @var Klikasi\Mapper\DbTable\TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param Klikasi\Mapper\DbTable\TableAbstract $dbTable
     * @return Klikasi\Mapper\Sql\Raw\MapperAbstract
     */
     ...
     * @param Klikasi\Model\Raw\ModelAbstract $model
    ...
    public function loadRelated($type, $name, $model, $conditions = null, $orderBy = null)
    {
        ...
        if ('parent' == $type && array_key_exists($name, $parents)) {
            ...
            $table_class = 'Klikasi\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
            ...
            $ref_table_name = 'Klikasi\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
        } else {
        ...
        if ($this->_cache &&
            ...
            $relMapperClassName = "\\Klikasi\\Mapper\\Sql\\" . $object_table_name;
     ...
     *
     * @see Klikasi\Mapper\DbTable\TableAbstract::countAllRows()
     ...
     *
     * @see Klikasi\Mapper\DbTable\TableAbstract::countByQuery()
     ...
     *
     * @param Klikasi\Model\Raw\ModelAbstract $model The model to delete
     * @return int
     */
    public abstract function delete(\Klikasi\Model\Raw\ModelAbstract $model);
    ...
    {
        $adapter = new \Klikasi\Model\Paginator($select, $this);
     ...
     * @return Klikasi\Model\Raw\ModelAbstract|null
     */
     ...
     * @return array All Klikasi\Model\Raw\ModelAbstract meeting the criteria
     */
     ...
     * @param Klikasi\Model\Raw\ModelAbstract|null $model
     * @return Klikasi\Model\Raw\ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return Klikasi\Mapper\DbTable\TableAbstract
     */
     ...
     *
     * @param new Klikasi\Model\Raw\ModelAbstract $model
     * @return array
     */
     ...
     * @param Klikasi\Model\Raw\ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
    protected abstract function loadModel($data, $entry);

    /**
     * Cleans urlIdentifier fields, so they can be used as url slugs
     * @param \Klikasi\Model\Raw\ModelAbstract $model The model to clean
     *
     */
    protected function _setCleanUrlIdentifiers(\Klikasi\Model\Raw\ModelAbstract $model)
    {
