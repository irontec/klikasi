...
class IkastegiaRelGaiak extends MapperAbstract
{
     ...
     */
    public function save(\Klikasi\Model\Raw\IkastegiaRelGaiak $model)
    {
     ...
     * @return boolean If the save action was successful
     */
    public function saveRecursive(\Klikasi\Model\Raw\IkastegiaRelGaiak $model, $useTransaction = true, $transactionTag = null)
    {
