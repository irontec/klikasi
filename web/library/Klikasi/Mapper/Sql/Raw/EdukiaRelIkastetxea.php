...
class EdukiaRelIkastegia extends MapperAbstract
{
     ...
     */
    public function save(\Klikasi\Model\Raw\EdukiaRelIkastegia $model)
    {
     ...
     * @return boolean If the save action was successful
     */
    public function saveRecursive(\Klikasi\Model\Raw\EdukiaRelIkastegia $model, $useTransaction = true, $transactionTag = null)
    {
