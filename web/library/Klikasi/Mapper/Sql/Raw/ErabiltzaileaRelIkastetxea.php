...
class ErabiltzaileaRelIkastegia extends MapperAbstract
{
     ...
     */
    public function save(\Klikasi\Model\Raw\ErabiltzaileaRelIkastegia $model)
    {
     ...
     * @return boolean If the save action was successful
     */
    public function saveRecursive(\Klikasi\Model\Raw\ErabiltzaileaRelIkastegia $model, $useTransaction = true, $transactionTag = null)
    {
