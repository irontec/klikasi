...
abstract class ModelAbstract implements \IteratorAggregate
{
     ...
     *
     * @var Klikasi\Model\Raw\ModelAbstract
     */
    protected $_mapper;
    ...
    */
     ...
     *
     * @var Klikasi\Model\ModelValidatorAbstract
     */
     ...
     *
     * @param array $data
     * @return Klikasi\Model\Raw\ModelAbstract
     */
     ...
     *
     * @return Klikasi\Model\Mapper\MapperAbstract
     */
     ...
     *
     * @param Klikasi\Model\Mapper\MapperAbstract $mapper
     * @return Klikasi\Model\Raw\ModelAbstract
     */
     ...
     *
     * @see Klikasi\Mapper\DbTable\TableAbstract::getPrimaryKeyName()
     ...
     *
     * @see Klikasi\Model\Mapper\MapperAbstract::toArray()
     * @return array
     */
     ...
     * Saves current row
     *
     * @see Klikasi\Model\Mapper\MapperAbstract::save()
     ...
     *
     * @see Klikasi\Model\Mapper\MapperAbstract::saveRecursive()
