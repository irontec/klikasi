...
class Esteka extends ModelAbstract
{
    ...
    /**
     * Parent relation fk_Esteka_Edukia1
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Klikasi\Model\Raw\Esteka
     */
     ...
     *
     * @return Klikasi\Mapper\Sql\Esteka
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Klikasi\Mapper\Sql\Esteka')) {

                $this->setMapper(new \Klikasi\Mapper\Sql\Esteka);
     ...
     *
     * @return null | \Klikasi\Model\Validator\Esteka
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Klikasi\\Validator\Esteka')) {

                $this->setValidator(new \Klikasi\Validator\Esteka);
            }
        }
