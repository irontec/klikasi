...
class Bideoa extends ModelAbstract
{
    ...
    /**
     * Parent relation fk_BIdeoa_Edukia1
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Klikasi\Model\Raw\Bideoa
     */
     ...
     *
     * @return Klikasi\Mapper\Sql\Bideoa
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Klikasi\Mapper\Sql\Bideoa')) {

                $this->setMapper(new \Klikasi\Mapper\Sql\Bideoa);
     ...
     *
     * @return null | \Klikasi\Model\Validator\Bideoa
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Klikasi\\Validator\Bideoa')) {

                $this->setValidator(new \Klikasi\Validator\Bideoa);
            }
        }
