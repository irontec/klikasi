...
class EtagVersions extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Klikasi\Model\Raw\EtagVersions
     */
     ...
     *
     * @return Klikasi\Mapper\Sql\EtagVersions
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Klikasi\Mapper\Sql\EtagVersions')) {

                $this->setMapper(new \Klikasi\Mapper\Sql\EtagVersions);
     ...
     *
     * @return null | \Klikasi\Model\Validator\EtagVersions
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Klikasi\\Validator\EtagVersions')) {

                $this->setValidator(new \Klikasi\Validator\EtagVersions);
            }
        }
