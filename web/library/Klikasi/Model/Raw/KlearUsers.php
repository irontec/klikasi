...
class KlearUsers extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Klikasi\Model\Raw\KlearUsers
     */
     ...
     *
     * @return Klikasi\Mapper\Sql\KlearUsers
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Klikasi\Mapper\Sql\KlearUsers')) {

                $this->setMapper(new \Klikasi\Mapper\Sql\KlearUsers);
     ...
     *
     * @return null | \Klikasi\Model\Validator\KlearUsers
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Klikasi\\Validator\KlearUsers')) {

                $this->setValidator(new \Klikasi\Validator\KlearUsers);
            }
        }
