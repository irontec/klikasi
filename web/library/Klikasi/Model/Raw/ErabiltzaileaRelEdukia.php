...
class ErabiltzaileaRelEdukia extends ModelAbstract
{
    ...
    /**
     * Parent relation fk_Erabiltzailea_has_Edukia_Edukia1
     *
    ...
    /**
     * Parent relation fk_Erabiltzailea_has_Edukia_Erabiltzailea1
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Klikasi\Model\Raw\ErabiltzaileaRelEdukia
     */
     ...
     *
     * @return Klikasi\Mapper\Sql\ErabiltzaileaRelEdukia
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Klikasi\Mapper\Sql\ErabiltzaileaRelEdukia')) {

                $this->setMapper(new \Klikasi\Mapper\Sql\ErabiltzaileaRelEdukia);
     ...
     *
     * @return null | \Klikasi\Model\Validator\ErabiltzaileaRelEdukia
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Klikasi\\Validator\ErabiltzaileaRelEdukia')) {

                $this->setValidator(new \Klikasi\Validator\ErabiltzaileaRelEdukia);
            }
        }
     ...
     *
     * @see \Mapper\Sql\ErabiltzaileaRelEdukia::delete
