...
class KanpainaRelEdukiKategoriak extends ModelAbstract
{
    ...
    /**
     * Parent relation KanpainaRelEdukiKategoriak_ibfk_1
     *
    ...
    /**
     * Parent relation KanpainaRelEdukiKategoriak_ibfk_2
     *
    ...
    ***************************************************************************/
     ...
     * @param int $data
     * @return \Klikasi\Model\Raw\KanpainaRelEdukiKategoriak
     */
     ...
     *
     * @return Klikasi\Mapper\Sql\KanpainaRelEdukiKategoriak
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Klikasi\Mapper\Sql\KanpainaRelEdukiKategoriak')) {

                $this->setMapper(new \Klikasi\Mapper\Sql\KanpainaRelEdukiKategoriak);
     ...
     *
     * @return null | \Klikasi\Model\Validator\KanpainaRelEdukiKategoriak
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Klikasi\\Validator\KanpainaRelEdukiKategoriak')) {

                $this->setValidator(new \Klikasi\Validator\KanpainaRelEdukiKategoriak);
            }
        }
     ...
     *
     * @see \Mapper\Sql\KanpainaRelEdukiKategoriak::delete
